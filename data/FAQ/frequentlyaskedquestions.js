[
    ...
    },
    {
        ...
        answer:'Yes. You can play most of Betway’s casino games for free with a demo version. However, demo versions are not available on live dealer casino games.' ,
    },
    {
        id:4,
    ...
    },
    {
        ...
        answer:'It's tough to put much stock into many customer reviews of Betway since they're often written by disgruntled customers who screwed up in some way (whether they knew it or not). We recommend reading Betway reviews from customers, but just be prepared to take them with a grain of salt. You might ignore the lone review that says something like "Betway never pays", and instead pay attention to reviews or patterns saying the same thing from multiple customers.
        
        Ultimately, though, we'd never recommend Betway.com if they were a scam site.' ,
    },
    {
        id:7,
        question: 'Betway isn't for me. Where should I play instead?',
        answer:'That's okay! Not every gambling site is a good fit for every gambler.

        If you're not interested in playing at Betway for real money, then here are two suggestions for where to look next. Our list of top-rated gambling sites is the fastest way to find a Betway alternative. However, if you're prepared to do some research, then you might want to comb through some of our gambling site reviews.' ,
    },
]