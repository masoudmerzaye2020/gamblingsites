        ...
        <Section>
            ...
            <p>We’ve ranked the best real money football betting sites for 2022, so you can safely bet football online with absolute confidence. They’re listed below, so check out these football betting sites if you’re ready to get in on the action.</p>
                ...
                <div className='my-4 flex flex-wrap m-auto max-w-[1900px] h-[150px] md:h-[200px] lg:h-[300px]'>
                    <Image className='flex w-full' src='/image/Safe-Trusted-Football-Betting-Sites.jpg' width='1800' height='100%' alt='football'/>
                </div>
                ...
                <div className='my-4 flex flex-wrap m-auto max-w-[1900px] h-[150px] md:h-[200px] lg:h-[300px]'>
                    <Image className='flex w-full' src='/image/Why-Bet-On-Football-Online.jpg' width='1800' height='100%' alt='football'/>
                </div>
