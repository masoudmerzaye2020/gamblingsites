  ...
  return (
    <>
      <div className="w-full bg-[#15365a] text-center p-2">
        <h1 className="text-2xl font-semibold text-gray-200 py-1">
      ...
      <Section>
        <Container>
          ...
          <p className={style.paragraph}>
            ...
            This website is a genuine goldmine for gamblers, with information
            and expert advice on just about every gambling-related topic under
            the sun. Our main objective is to ensure you enjoy safe online
            betting and gaming at reputable and trustworthy gambling sites.
            You’ll find full details on everything else we have to offer
            throughout this page, but let’s start with our latest rankings of
