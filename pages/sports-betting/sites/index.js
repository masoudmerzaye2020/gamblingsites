    ...
    <>
        ...
        <Section>
            <Container>
              ...
              <p>Targeting sports and competitions that you know well is crucial for your chances to win when you bet online, but that’s only part of the equation. Another step that could help is choosing a site based on the sports you prefer to bet on. We have plenty of pages that can help with that.</p>
              <div className='flex w-[90%] flex-wrap mx-auto'>
                
                <div className='w-10/12 s:w-6/12 md:w-4/12 lg:w-3/12 p-4 mx-auto'>
                  <div className='flex flex-col max-w-[160px] max-h-[100%] mx-auto'>
                    <Image src='/image/UFC-Betting-Sites.png' width='200px' height='200px' alt='image'/>
                    <button className='my-6 bg-yellow-300 w-full rounded-lg py-3 uppercase'>football bettin sites</button>
                  </div>
                </div>
                <div className='w-10/12 s:w-6/12 md:w-4/12 lg:w-3/12 p-4 mx-auto'>
                  <div className='flex flex-col max-w-[160px] max-h-[100%] mx-auto'>
