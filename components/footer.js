                    ...
                    <div className="no-uderline underline-none">
                      ...
                      {menu.submenu.map((submenu, index) => {
                        return (
                          <div
                            key={index}
                            className="no-underline p-[2px] sans-serif font-normal no-underline "
                          >
                            <Link href={submenu.url}>
                              <a className="hover:underline hover:text-gray-500 visited:text-purple-600">
                                {submenu.title}
                              </a>
                            </Link>
                          </div>
              ...
              <div>
                <div>
                  <p className="text-gray-300">
                    We Offer{" "}
                    <Link href="/">
                      <a className="text-yellow-400 underline">
