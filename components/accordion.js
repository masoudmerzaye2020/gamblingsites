...
export default function Accordion({ title, content }) {
    ...
    return (        
        ...
        <div className="flex flex-wrap  lg:w-10/12  mx-auto bg-gray-200  border-[1px] border-gray-800 rounded-lg font-paragraph hover:bg-slate-700">
          <div className="sm:w-11/12 lg:text-2xl  md:text-2xl  py-2 px-3 " onClick={toggle}  type="button">{title}</div>
          <div className="sm:w-1/12   items-center justify-center mx-auto my-auto text-center">   <button className=" items-end justify-items-end ml-2 place-items-end place-content-end">
                  <ArrowDropDownIcon  
                onClick={toggle}
